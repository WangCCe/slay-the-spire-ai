...
- Registration SHA-256: `17b7f03854ae96aa5d46eb9d684e8cd6d74c48185c30e4062abcda599a8e5e93`
...
- `primary_terminal_victory`: `true`
- `reference_labels_excluded`: `true`
- `secondary_floor_role_explicit`: `true`
- `simulator_live_provenance_separated`: `true`
- `verification_checks_pass`: `true`
- Details: `{"formal_reward_contract_id":"noncombat-formal-reward-contract-v1","simulator_reward":{"max_floor":57,"progress_divisor":57.0,"version":"simulator-floor-progress-victory-v1","victory_bonus":1.0}}`
