...
def test_ironclad_strategy_prefers_inflame_over_rage_before_act2_scaling():
    deck = [
        _card("Strike_R"),
        _card("Strike_R"),
        ...
        _card("Defend_R"),
        _card("Bash", cost=2),
        _card("Carnage", cost=2, upgrades=1),
...
def test_ironclad_strategy_prefers_inflame_over_second_anger_before_guardian():
    deck = [
        _card("Strike_R"),
        _card("Strike_R"),
        _card("Strike_R"),
        ...
        _card("Power Through"),
        _card("Blood for Blood", cost=4, upgrades=1),
        _card("Dropkick"),
