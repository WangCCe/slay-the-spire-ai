# Non-Combat Teacher Sufficiency Audit Runtime Recovery

## Purpose

Define an equivalence-preserving, one-shot recovery for a consumed
teacher-sufficiency audit that exceeded its fixed runtime bound before
publication.
