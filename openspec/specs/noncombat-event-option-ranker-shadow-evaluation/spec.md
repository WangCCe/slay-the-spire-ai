# noncombat-event-option-ranker-shadow-evaluation Specification

## Purpose
TBD - created by archiving change evaluate-event-option-ranker-shadow. Update Purpose after archive.
## Requirements
