# noncombat-ope-estimator-validation Specification

## Purpose
Define the exact, deterministic, independently replayable estimator and calibration contracts required to turn an overlap-ready non-combat trajectory pool into an offline OPE estimate without authorizing training or live policy promotion.
