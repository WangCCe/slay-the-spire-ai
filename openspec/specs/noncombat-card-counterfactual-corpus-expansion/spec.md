# noncombat-card-counterfactual-corpus-expansion Specification

## Purpose
TBD - created by archiving change add-card-counterfactual-corpus-expansion. Update Purpose after archive.
## Requirements
