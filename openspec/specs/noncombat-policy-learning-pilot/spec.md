# noncombat-policy-learning-pilot Specification

## Purpose
Define the reproducible, leakage-free, offline supervised policy-learning pilot used to validate non-combat representations and evaluation discipline without enabling formal RL or live policy promotion.
