# noncombat-event-option-counterfactual-ranking-training Specification

## Purpose
TBD - created by archiving change train-event-option-counterfactual-ranker. Update Purpose after archive.
## Requirements
