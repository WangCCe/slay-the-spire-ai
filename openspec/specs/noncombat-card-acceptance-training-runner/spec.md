# noncombat-card-acceptance-training-runner Specification

## Purpose
Define the exact source, authority, lifecycle, rollback, and dead-owner
terminalization boundaries for the bounded r6 card-acceptance paired training
runner, including execution-inert source-only preflight and independent
verification.
## Requirements
