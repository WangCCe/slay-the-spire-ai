# noncombat-card-action-counterfactual-credit-poc Specification

## Purpose

Define bounded, source-preserving card-action counterfactual return evidence and
the viability boundary for later training integration.
