# noncombat-card-uplift-live-shadow Specification

## Purpose

Define the explicit, source-bound live shadow boundary used to compare the
frozen card-uplift candidate with Current without granting gameplay authority.
