# noncombat-formal-reward-contract Specification

## Purpose

Define a source-bound, deterministic formal reward contract for non-combat RL
design without authorizing training, gameplay, evaluation, or promotion.
