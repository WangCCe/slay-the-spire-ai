...
Define the bounded, isolated continuation protocol used to test whether additional
card-only candidate updates produce material policy behavior changes without
granting fresh-evaluation, gameplay, promotion, or production-loading authority.
