# combat-lightspeed-parent-card-ranking-guard Specification

## Purpose
TBD - created by archiving change add-combat-lightspeed-parent-card-ranking-guard. Update Purpose after archive.
## Requirements
