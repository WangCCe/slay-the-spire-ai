# Combat RL Latent-Gated Live Shadow Specification

## Purpose

Define source-bound, behavior-neutral live observation and readiness reporting for latent-gated combat RL candidates before any matched gameplay authority is considered.
