# noncombat-family-preserving-conditional-card-ranking Specification

## Purpose
TBD - created by archiving change train-family-preserving-conditional-card-ranker. Update Purpose after archive.
## Requirements
