# combat-rl-provenance-balanced-anchor Specification

## Purpose

Define optional provenance-balanced parent-policy anchoring, direct-only margin
protection, and bounded objective-design ablations for combat RL successors.
