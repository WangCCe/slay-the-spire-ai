# combat-lightspeed-parent-top-action-margin-guard Specification

## Purpose
TBD - created by archiving change add-combat-lightspeed-parent-top-action-margin-guard. Update Purpose after archive.
## Requirements
