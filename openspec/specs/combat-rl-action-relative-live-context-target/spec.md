# Combat RL Action-Relative Live Context Target Specification

## Purpose

Define source-bound parent-only live opportunity capture, exact decision-state
joining, fresh holdout sufficiency, and immutable context-target publication
for action-relative successor support evaluation.
