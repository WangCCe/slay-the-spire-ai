# combat-rl-real-context-balanced-corpus Specification

## Purpose

Define targeted late-floor paired-return supplementation, deterministic
real-context weighting, support gates, immutable publication, and downstream
authority boundaries for combat RL corpus evidence.
