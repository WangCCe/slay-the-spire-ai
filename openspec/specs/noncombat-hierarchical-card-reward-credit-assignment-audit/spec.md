# noncombat-hierarchical-card-reward-credit-assignment-audit Specification

## Purpose

Define the immutable, source-only audit that reconstructs hierarchical
card-reward decisions, measures direct take-family logit pressure under fixed
descriptive strata, publishes a bounded verdict, and grants no downstream
