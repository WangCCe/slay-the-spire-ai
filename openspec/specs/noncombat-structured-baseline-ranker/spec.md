# noncombat-structured-baseline-ranker Specification

## Purpose

Define leakage-controlled structured candidate features, seed-grouped
train-only comparison, real multi-candidate competence metrics, deterministic
artifacts, and no-authority verdicts for baseline-ranker implementation POCs.
