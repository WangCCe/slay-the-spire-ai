# noncombat-baseline-warm-start Specification

## Purpose

Define an immutable, baseline-anchored supervised warm-start study and its
strict evidence, stopping, reproduction, and no-authority boundaries.
