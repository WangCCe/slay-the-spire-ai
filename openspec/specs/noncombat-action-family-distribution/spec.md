# noncombat-action-family-distribution Specification

## Purpose

Define an additive, source-only hierarchical probability distribution over
validated non-combat action families and their candidate actions, with explicit
entropy decomposition and no empirical or runtime authority.
