# Non-Combat State-Conditioned Policy Input Specification

## Purpose

Define the validated separate state/candidate feature boundary and canonical
diagnostic rows used by future state-conditioned non-combat policy work without
granting experiment or gameplay authority.
