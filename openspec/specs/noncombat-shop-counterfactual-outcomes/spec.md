# Noncombat Shop Counterfactual Outcomes Specification

## Purpose

Define bounded, reproducible simulator evidence for supported non-combat shop
actions before any separate learning proposal is authorized.
