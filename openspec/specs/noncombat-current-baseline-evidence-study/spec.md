# Non-Combat Current Baseline Evidence Study Specification

## Purpose

Define the immutable two-stage Current-versus-weak-control study,
conservative support handling, numeric floor gates, deterministic publication,
and no-training authority boundary.
