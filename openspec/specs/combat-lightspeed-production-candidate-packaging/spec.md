# combat-lightspeed-production-candidate-packaging Specification

## Purpose

Define deterministic, hash-closed conversion of an eligible simulator-only RL v2 combat candidate into an isolated production-loadable weights checkpoint with exact equivalence evidence and no implicit live authority.
