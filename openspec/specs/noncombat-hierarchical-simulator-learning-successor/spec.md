# noncombat-hierarchical-simulator-learning-successor Specification

## Purpose

Define the isolated hierarchical simulator-learning successor, its family-first
training objective, fixed controls and cohorts, bounded evidence lifecycle,
anti-collapse gates, canonical publication, and no-downstream-authority
boundary.
