# noncombat-large-corpus-card-uplift-residual Specification

## Purpose
TBD - created by archiving change add-large-corpus-card-uplift-residual. Update Purpose after archive.
## Requirements
