# noncombat-card-only-native-baseline-rl-pilot Specification

## Purpose
TBD - created by archiving change add-card-only-native-baseline-rl-pilot. Update Purpose after archive.
## Requirements
