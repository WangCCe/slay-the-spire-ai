# noncombat-simulator-policy-validity Specification

## Purpose

Define a deterministic, immutable, simulator-only evaluation that compares a
frozen candidate policy with fixed same-schema baselines before any formal
non-combat RL proposal can be considered.
