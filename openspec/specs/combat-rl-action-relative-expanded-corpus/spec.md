# combat-rl-action-relative-expanded-corpus Specification

## Purpose

Define immutable native paired-return corpus generation, partition identity,
sufficiency, provenance, and authority boundaries for expanded action-relative
combat classifier cohorts.
