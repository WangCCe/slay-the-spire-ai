# noncombat-card-counterfactual-scorer-weight-pilot Specification

## Purpose

Define reusable card counterfactual datasets and a bounded scorer-weight-only
training pilot with a development-before-audit access gate.
