# noncombat-card-counterfactual-uplift-residual-crossfit Specification

## Purpose

Define immutable source-only inputs, nested seed-grouped development, frozen
entry card-uplift residual fitting, and a no-authority audit proposal gate.
