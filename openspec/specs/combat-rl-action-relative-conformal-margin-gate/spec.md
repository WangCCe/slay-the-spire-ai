# combat-rl-action-relative-conformal-margin-gate Specification

## Purpose

Define seed-disjoint calibration, action-family conformal margins, immutable
development artifacts, and fixed offline/fresh-simulator decisions for
action-relative combat RL candidates.
