# adaptive-elite-routing Specification

## Purpose
Define deterministic state-aware Ironclad elite routing, bounded two-candidate selection, observability, rollback, and no-training qualification evidence.
