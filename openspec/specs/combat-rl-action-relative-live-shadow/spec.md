# combat-rl-action-relative-live-shadow Specification

## Purpose

Define the source-bound, behavior-neutral live shadow used to evaluate a
post-guard action-relative combat residual before any candidate action authority.
