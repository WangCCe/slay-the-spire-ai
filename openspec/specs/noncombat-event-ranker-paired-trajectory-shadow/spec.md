# noncombat-event-ranker-paired-trajectory-shadow Specification

## Purpose

Define reproducible paired full-trajectory simulator evidence for evaluating a
manifest-bound event-policy overlay against Current without granting gameplay or
promotion authority.
