# noncombat-card-only-scorer-optimizer-replay-ablation Specification

## Purpose

Define a bounded, reproducible offline replay contract for comparing the current
full card-policy optimizer with exact parameter-subset optimizer ablations.
