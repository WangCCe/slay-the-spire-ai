# combat-rl-action-relative-matched-live-gate Specification

## Purpose
TBD - created by archiving change add-combat-rl-action-relative-matched-live-gate. Update Purpose after archive.
## Requirements
