...
- [x] 1.2 Add RED tests for fold/trajectory leakage, split trajectories,
...
- [x] 1.3 Add RED tests for exact component/parameter identity, full-gradient
  ...
  deltas.
- [x] 1.4 Add RED synthetic fixtures for aligned and opposing row-local versus
...
- [x] 2.1 Implement immutable trajectory/fold and fit-set records, canonical
...
- [x] 2.2 Implement the five fixed scalar component boundary, ordered named
...
- [x] 2.3 Implement one complete-gradient norm and uniform clip factor at the
...
- [x] 2.4 Implement deterministic tiny shared-ranker evidence, tie fixtures,
...
- [x] 3.1 Turn every RED boundary green, run the full focused suite plus
...
- [x] 3.2 Obtain an independent implementation and interpretation review;
  resolve every actionable finding and rerun only affected focused/relevant
  tests before publication.
- [x] 3.3 Publish the deterministic source-only design report and update
...
- [x] 3.4 Run the repository `commit` test gate once, sync the accepted
