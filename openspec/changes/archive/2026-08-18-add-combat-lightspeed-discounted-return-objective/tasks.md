...
- [x] 3.2 Run each arm once, apply aggregate and battle-index guardrails, and record the retained parent decision
- [x] 3.3 Sync the main spec, archive the completed change, commit the evidence, and push master
