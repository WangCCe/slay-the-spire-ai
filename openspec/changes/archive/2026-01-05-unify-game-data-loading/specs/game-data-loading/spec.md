...
## Purpose
Define a unified, robust system for loading game metadata from Slay the Spire's export files (items.json) to support accurate AI decision-making, particularly for combat simulation.
