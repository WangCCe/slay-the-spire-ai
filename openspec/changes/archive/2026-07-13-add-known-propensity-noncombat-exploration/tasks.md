...
- [x] 4.4 Run a dry-run process smoke with the Windows production Python and verify startup, manifest provenance, default behavior, and clean shutdown before any nonzero exploration batch.
...
- [x] 6.5 Obtain independent raw-evidence and code review, resolve accepted findings with regressions, rerun focused/full verification, and leave OPE, causal uplift, formal RL, and live promotion blocked.
