...
## Purpose
Define dynamic calculation logic for X-damage and X-block cards in the combat simulation system, enabling the AI to accurately evaluate powerful cards like Body Slam, Rage, and Whirlwind that currently appear to have 0 value.
