...
- [x] 1.1 Record the exact r2 and baseline-audit inputs, disclosed exploratory
  probe, support minima, acceptance and conditional formulas, trend predicates,
  verdict decision tree, all-false authority, success metric, non-goals, and
  rollback boundary.
- [x] 1.2 Strictly validate, independently review, commit, and push the complete
  OpenSpec plan before changing executable source or tests.
...
- [x] 2.2 Add RED tests for pushed source and reused-source binding, prior-report
  ...
  report size, and forbidden-import isolation.
