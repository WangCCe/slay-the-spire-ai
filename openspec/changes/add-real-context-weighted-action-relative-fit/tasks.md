...
- [x] 1.1 Add focused regressions for exact input binding, even/odd seed
...
- [x] 1.2 Add focused regressions for state-mass-preserving classification and
  ranking weights, deterministic replacement plans, zero-weight exclusion, and
  fixed recipe enforcement.
- [x] 1.3 Add focused regressions for the weighted higher calibration quantile,
...
- [x] 2.1 Implement the compact source-bound runner that validates and combines
...
- [x] 2.2 Implement deterministic weighted classification and ranking sample
  plans while preserving the item-semantic model, frozen parent, optimizer,
  update budget, and loss recipe.
- [x] 2.3 Implement weighted negative calibration, raw plus weighted fresh
