...
- [x] 1.1 Strictly validate proposal, design, delta requirements, fixed r2
  identities, support thresholds, verdict precedence, output paths, and all-
  false authority.
- [x] 1.2 Commit and push the complete OpenSpec plan before adding audit source,
  tests, or analytical reports.
