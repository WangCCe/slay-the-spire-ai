...
## Purpose
Detect and evaluate enemies with dangerous scaling mechanics (strength gain, multihit combos, etc.) to trigger aggressive mode against non-elite but still dangerous enemies.
