...
## Purpose
Implement aggressive combat mode for elite fights that dramatically prioritizes damage over defense to enable fast kills before elite scaling mechanics overwhelm the player.
