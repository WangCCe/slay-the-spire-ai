...
- [x] 2.1 Implement independent native-control and card-only candidate whole-run rollouts
- [x] 2.2 Record candidate-state native interventions, action legality, support censors, paired outcomes, and deterministic bootstrap metrics
- [x] 2.3 Enforce fixed completion, support, intervention, floor, victory, resource, and immutability gates
