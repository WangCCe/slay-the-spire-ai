...
- [x] 3.2 Rerun the frozen guarded-control experiment with the proxy, verify unchanged candidate parameter identity, and publish a bounded counterfactual report.
- [x] 3.3 Record the transfer conclusion and either reject further live spending for this candidate family or define a separately reviewed next step; do not promote from proxy evidence.
