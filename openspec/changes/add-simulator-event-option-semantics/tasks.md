...
- [ ] 4.1 Run focused adapter and bridge pytest with an isolated writable basetemp.
...
- [ ] 4.3 Update project direction and a closeout report with semantic coverage, predecessor comparison, verdict, authority limits, and rollback boundary.
