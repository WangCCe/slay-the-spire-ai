...
- [ ] 6.1 Run source-only preflight, then load native before Torch and execute
...
- [ ] 6.2 After process exit, preserve and independently verify the exact
...
- [ ] 6.3 Publish a read-only interpretation and project-direction update that
