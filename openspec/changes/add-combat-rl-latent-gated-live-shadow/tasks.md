...
- [ ] 4.3 Commit a bounded production-r16 shadow registration, run a fresh live cohort, reconcile trace, `.run`, `ai_debug.log`, and `communication_mod_errors.log`, and publish a matched-gate go/no-go report.
