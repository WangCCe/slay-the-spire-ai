...
source/objective/optimizer/verifier bindings. The
current capability SHALL accept no path, seed, cohort, checkpoint, environment
factory, execution, or optimizer-state input and SHALL keep model fitting, loading,
native loading, environment construction, seed access, replay, execution,
training, gameplay, formal RL, qualification, and promotion authority false.
