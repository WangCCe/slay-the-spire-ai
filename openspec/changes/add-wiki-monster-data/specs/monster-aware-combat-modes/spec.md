# monster-aware-combat-modes Specification Delta

## Purpose

Enhance combat mode selection (AGGRESSIVE/SEMI_AGGRESSIVE/BALANCED) to use detailed monster data for more intelligent mode selection based on monster composition, special mechanics, and threat profiles.
...
- **scaling-threat-evaluation** - Enhances combat mode selection with detailed monster data instead of basic threat detection

This specification depends on:
- **monster-data-loading** - Requires monster_type, special_mechanics, threat_profile data

This specification enables:
- **enhanced-threat-assessment** - Combat mode influences threat scoring weights
- **intelligent-targeting** - Combat mode guides targeting priorities
