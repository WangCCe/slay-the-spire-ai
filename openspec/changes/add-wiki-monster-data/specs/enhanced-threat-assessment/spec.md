# enhanced-threat-assessment Specification Delta

## Purpose

Extend the threat evaluation system to use predictive threat calculation based on monster move patterns, special mechanics, and future threat potential. This enables proactive decision-making instead of reactive responses to current monster intent.
...
- **ai-combat** - Enhances Threat-Based Targeting requirement with predictive threat
- **scaling-threat-evaluation** - Enhances Scaling Mechanic Detection with detailed threat profiles
- **monster-data-loading** - Uses monster move patterns and threat profiles for prediction

This specification enables:
- **intelligent-targeting** - Provides enhanced threat scores for target prioritization
- **monster-aware-combat-modes** - Provides scaling threat for combat mode selection
- **combat-simulation-enhancement** - Provides future threat for beam search scoring
