...
- [ ] 4.1 Execute the registered 64-update recipe exactly once on the fresh corpus.
- [ ] 4.2 Audit candidate hashes and every stratified gate without same-corpus tuning or rerun.
